...
<%--      <c:forEach var="item" items="${cartItems}" begin="${cartItems.size()-1}"  step="-1" end="${cartItems.size()-4}" >--%>
...
<%--            <p class="mb-0"><a href="#" class="price">$25.99</a><span class="quantity ml-3">Quantity: ${item.count}</span></p>--%>
<%--          </div>--%>
<%--        </div>--%>
<%--        </c:forEach>--%>
<%--        <div class="dropdown-item d-flex align-items-start" href="#">--%>
